...
export function registerEditorSettings() {
  ...
  settings.register([
    ...
    { key: 'editor.wordWrap', type: 'enum', enum: ['off', 'on'], enumDescriptions: ['Lines will never wrap.', 'Lines will wrap at the viewport width.'], default: phone ? 'on' : 'off', title: 'Word Wrap', description: 'Controls how lines should wrap. On phones lines wrap by default so code never scrolls sideways.', category: 'Text Editor', order: 4, common: true },
